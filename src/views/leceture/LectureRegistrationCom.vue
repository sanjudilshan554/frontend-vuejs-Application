                    ...
                    <div class="card-body p-md-5 text-black">
                        ...
                        <div class="col-md-3 mb-4">
                          <div class="form-outline">
                            <input
                              type="text"
                              id="styrSub"
                              v-model="Lecture.styrSub"
                              class="form-control form-control-lg"
                            />
                            <label class="form-label" for="province"
                              >First year Sub</label
                            >
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-4">
                          <div class="form-outline">
                            <input
                              type="text"
                              id="ndyrSub"
                              v-model="Lecture.ndyrSub"
                              class="form-control form-control-lg"
                            />
                            <label class="form-label" for="ndyrSub"
                              >Seconnd year Sub</label
                            >
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-4">
                          <div class="form-outline">
                            <input
                              type="text"
                              id="rdyrSub"
                              v-model="Lecture.rdyrSub"
                              class="form-control form-control-lg"
                            />
                            <label class="form-label" for="coutry"
                              >Third year Sub</label
                            >
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-4">
                          <div class="form-outline">
                            <input
                              type="text"
                              id="thyrSub"
                              v-model="Lecture.thyrSub"
                              class="form-control form-control-lg"
                            />
                            <label class="form-label" for="thyrSub"
                              >Fourth year Sub</label
                            >
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-outline mb-4">
                        <input
                          type="text"
                          id="EduQualification"
                          v-model="Lecture.EduQualification"
                          class="form-control form-control-lg"
                        />
                        <label class="form-label" for="thyrSub"
...
export default {
  ...
  methods: {
    save() {
      axios
        .post("http://127.0.0.1:8000/api/lecturereg", this.Lecture)
        .then((response) => {
