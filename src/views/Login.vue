                ...
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <form @submit.prevent>
                    ...
                    <div class="form-outline mb-4">
                      <input type="email" v-model="student.unvRegNo"  class="form-control"
                        placeholder="Index number" />
                      <label class="form-label" for="form2Example11">Index number</label>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-center pb-4">
                      ...
                      <router-link to="/student/register"  ><button type="button" class="btn btn-outline-danger">Create new</button></router-link>
                    </div>
