                    ...
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <form>
                        ...
                        <div class="form-outline mb-4">
                          <input type="text" id="form2Example11" class="form-control" v-model="lecture.empNo" 
                            placeholder="Emp number" />
                          <label class="form-label" for="form2Example11">Employee Number</label>
                        </div>
      
                        <div class="form-outline mb-4">
                          <input type="password" id="form2Example22" class="form-control" v-model="lecture.password"/>
