<template>
      ...
      <nav class="bg-dark navbar-dark">
        <div class="container">
          <div class="text">
          <a href="" class="navbar-brand" style="color:gray;text-align:center;" ><i class="fas fa-tree mr-2"></i>Learning area for all users</a>
        </div>
        </div>
        </nav>
         <section id="header" class="jumbotron text-center">
          ...
          <div class="imporve">
            <div class="textt">
           <h1 class="display-3 ">LEARN +</h1>
            </div>
           <br>
           <div class="dc">
           <p class="lead" >Learning Today ... Leading Tommorrow.</p>
          </div>
          </div>
           <br>
      </section>
